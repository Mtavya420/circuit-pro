...
export default function getDirs(
  ...
  const pageDirs = dirs
    ...
    .map(
      (dir) => [dir, path.resolve(pagesDir, dir.name, "package.json")] as const
    )
  ...
  return [
      ...
      ? [
          {
            ...
            title: "Server",
            description: "The backend server for circuitPro",
            value: "server",
          },
        ]
      : []),
    ...(includeApp
      ? [
          {
            // Add in app directory
            title: "App",
            description: "The application logic for circuitPro",
            value: "app",
          },
        ]
      : []),
    ...(includeShared
      ? [
          {
            // Add in the site/shared directory
            title: "Shared",
            description: "The shared site code for circuitPro",
            value: "site/shared",
          },
        ]
      : []),
