  ...
  return (
    <>
      <div className="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-left">
        ...
        <p className="lead">
          Quickly build and test digital circuitry with an easy-to-use, online,
          and completely free interface!
        </p>
      </div>
      ...
      <div className="container-fluid circuit-launch-wrapper mb-5">
        <button
          ...
          className={`btn btn-outline-dark py-1 px-0 circuit-launch-wrapper-btn-1
                           ${
                             sim === "digital"
                               ? "circuit-launch-wrapper-btn-selected"
                               : ""
                           }`}
        ...
        <div className="circuit-launch-wrapper-output-div">
          ...
          >
            <img
              ...
              src="img/digital-logo.svg"
              alt="Digital Logo"
            />
            <div className="card-body p-2">
              <p className="card-text font-weight-light">
                The original circuitPro with entirely digital components.
              </p>
          ...
          >
            <img
              className="card-img-top p-2"
              src="img/analog-logo.svg"
              alt="Analog Logo"
            />
            <div className="card-body p-2">
              <p className="card-text font-weight-light">
                The new, in progress, circuitPro EE with analog components.
              </p>
        ...
        <img
          className="circuit-launch-wrapper-gate"
          src="img/xorgate.svg"
          alt="XOR Gate"
        />
      </div>
