...
export const SideNav = ({ helpers, exampleCircuits }: Props) => {
  const { auth, circuits, isOpen, loading, loadingCircuits } =
      ...
      <div className={`sidenav ${isOpen ? "" : "sidenav__move"}`}>
        ...
        <div className="sidenav__content">
              ...
              circuits.map((circuit, i) => (
                <CircuitPreview
                  ...
                  onClick={async () => {
                    ...
                    await helpers.LoadCircuit(() =>
                      LoadUserCircuit(auth, circuit.getId())
                    );
                    dispatch(ToggleSideNav());
                  }}
                  onDelete={() => {
          ...
          <div className="sidenav__content__footer">
            ...
            and our great{" "}
            <a
              href="https://www.github.com/circuitPro/circuitPro/blob/master/AUTHORS.md"
              target="_blank"
              rel="noopener noreferrer"
            >
              team
